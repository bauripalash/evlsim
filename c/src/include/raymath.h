...
// Function specifiers definition
  ...
  #define RMAPI       \
      __attribute__(( \
          visibility("default")))  // We are building raylib as a Unix shared
                                   // library (.so/.dylib)
...
RMAPI Vector2 Vector2MoveTowards(Vector2 v, Vector2 target,
                                 float maxDistance) {
    Vector2 result = {0};
...
// Move Vector towards target
RMAPI Vector3 Vector3MoveTowards(Vector3 v, Vector3 target,
                                 float maxDistance) {
    Vector3 result = {0};
...
RMAPI Vector3 Vector3Unproject(Vector3 source, Matrix projection,
                               Matrix view) {
    Vector3 result = {0};
...
// Move Vector towards target
RMAPI Vector4 Vector4MoveTowards(Vector4 v, Vector4 target,
                                 float maxDistance) {
    Vector4 result = {0};
...
RMAPI Matrix MatrixFrustum(double left, double right, double bottom,
